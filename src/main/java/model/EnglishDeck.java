...
//            this.cards.add(this.cardCreator.createDiamondCard(value));
//            this.cards.add(this.cardCreator.createClubCard(value));
//            this.cards.add(this.cardCreator.createHearCard(value));
//            this.cards.add(this.cardCreator.createSpadeCard(value));
//        }
    }
